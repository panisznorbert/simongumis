...
$_documentContainer.innerHTML = `<dom-module id="simongumis-app-layout-theme" theme-for="vaadin-app-layout">
  <template>
    <style>
      :host {
...
<dom-module id="simongumis-login-theme" theme-for="vaadin-login-overlay-wrapper">
  <template>
    <style>
      [part="brand"] {
